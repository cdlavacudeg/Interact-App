...
const CardActivity = () => {
    ...
    let events = useSelector(state=>state.course.events.events)
            ...
            events.map((event,index)=>{
                return (
                    <div className="cardActivity" key={index}>
                        ...
                        <p className="cardActivity-title">{event.description}</p>
                        <p className="cardActivity-body">Fecha limite: <span>{event.date}</span></p>
                        </div>
